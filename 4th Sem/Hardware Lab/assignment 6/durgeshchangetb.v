...
module MIN_MAX_ALGORITHM_TB;
    ...
    initial begin
        $monitor($time, " ao=%d, do=%d, vo=%b,CNT=%d,MAXA=%d,MAXV=%d,MINA=%d,MINV=%d,MDR=%d,MAR=%d,ONE=%d,ceq=%d,vd=%b,current_state=%d, m0=%b, m1=%b,m2=%b,m3=%b,m4=%b,m5=%b,m6=%b,m7=%b,m8=%b,m9=%b,m10=%b,m11=%b,m12=%b,m13=%b,m14=%b,m15=%b,", 
