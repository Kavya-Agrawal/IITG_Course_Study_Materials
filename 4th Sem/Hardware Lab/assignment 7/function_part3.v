        ...
        begin
            case (current_state)
                ...
                3'b001: begin // input state
                    if (i == 4'b1010) next_state = 3'b010; 
...
// Each MUX_REGx corresponds to column x+1
// Each .inN of a mux corresponds to row N+1
// input_matrix[319:0] stores 80 4-bit numbers row-wise
// So: input_matrix[319 - (row * 8 + col) * 4 -: 4]
