...
module LONG_CHAIN_ADDITION_PART2_tb;
    ...
    // Internal test signals (register contents)
    // wire [6:0] test_r0, test_r1, test_r2, test_r3;
    // wire [6:0] test_r4, test_r5, test_r6, test_r7;
    // wire [6:0] test_x0, test_x1, test_x2, test_x3;
    // wire [6:0] test_y0, test_y1, test_z;
    ...
    initial begin
        ...
        // Wait for FSM to complete operation
        #100;
